...
init()
root = Tk()
root.title("CodingThumbs Expense tracker")
root.geometry('800x600')

dateLabel = Label(root, text="Date", font=('lucida handwriting', 15, 'bold'), bg="pink", fg="blue", width=12)
dateLabel.grid(row=0, column=0, padx=7, pady=7)

dateEntry = DateEntry(root, width=12, font=('lucida handwriting', 15, 'bold'))
dateEntry.grid(row=0, column=1, padx=7, pady=7)

Name = StringVar()
nameLabel = Label(root, text="Name", font=('lucida handwriting', 15, 'bold'), bg="pink", fg="blue", width=12)
nameLabel.grid(row=1, column=0, padx=7, pady=7)

NameEntry = Entry(root, textvariable=Name, font=('lucida handwriting', 15, 'bold'))
NameEntry.grid(row=1, column=1, padx=7, pady=7)

Title = StringVar()
titleLabel = Label(root, text="Title", font=('lucida handwriting', 15, 'bold'), bg="pink", fg="blue", width=12)
titleLabel.grid(row=2, column=0, padx=7, pady=7)

titleEntry = Entry(root, textvariable=Title, font=('lucida handwriting', 15, 'bold'))
titleEntry.grid(row=2, column=1, padx=7, pady=7)

Expense = IntVar()
expenseLabel = Label(root, text="Expense", font=('lucida handwriting', 15, 'bold'), bg="pink", fg="blue", width=12)
expenseLabel.grid(row=3, column=0, padx=7, pady=7)

expenseEntry = Entry(root, textvariable=Expense, font=('lucida handwriting', 15, 'bold'))
expenseEntry.grid(row=3, column=1, padx=7, pady=7)

submitbtn = Button(root, command=submitexpense, text="Submit", font=('lucida handwriting', 15, 'bold'), bg="pink", fg="blue",
                   width=12)
submitbtn.grid(row=4, column=0, padx=13, pady=13)

viewtn = Button(root, command=viewexpense, text="View expenses", font=('lucida handwriting', 15, 'bold'), bg="pink",
                fg="blue", width=12)
